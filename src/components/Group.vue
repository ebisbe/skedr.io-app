    ...
    <div>
                ...
                <v-slide-y-transition mode="out-in">
                    <v-layout row wrap>
                        <v-flex md9 xs12>
                            ...
                            <v-expansion-panel popout v-if="groups.length > 0">
                                            ...
                                            <v-container grid-list-md>
                                                <v-layout row wrap>
                                                    <v-flex md3 sm4 xs6 v-for="photo in group.photos" :key="photo.id">
                                                        <photo :photo="photo"
                                                               :addingPhotos="addingPhotosToGroup"></photo>
                                                    </v-flex>
                                                </v-layout>
                                            </v-container>
                                        </v-card-text>
                    ...
                    <v-flex xs6 v-for="photo in $store.state.pool" :key="photo.id">
                        <v-card tile>
                            <v-card-media :src="photo.url_m" height="150px">
                                <v-btn class="gray darken-2" fab small light
        ...
        <v-dialog v-model="dialog" :fullscreen="!addingPhotosToGroup" transition="dialog-bottom-transition"
            ...
            <v-card :class="{hidden: !addingPhotosToGroup}">
                ...
                <v-card-text>
                    <ul>
                        <li v-for="group in groups" v-if="group.checked" v-html="group.name"></li>
                    </ul>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      pushPhotosToGroups () {
        let matches = _.filter(this.groups, {checked: true})
