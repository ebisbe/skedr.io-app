  ...
  <div>
    ...
    <div
      :class="{
        ...
        'px-5 pt-4': $vuetify.breakpoint.smAndUp
      }"
    >
      <v-stepper v-model="step" class="elevation-0" vertical>
        ...
        <v-stepper-content step="1">
          ...
          <br />
          <v-btn :disabled="protectedUI" color="primary" @click="handleSubmit">
            {{ this.$i18n.t(button) }}
          </v-btn>
        </v-stepper-content>
        ...
        <v-stepper-content step="3">
          ...
          <v-form @submit.stop.prevent="validateCode">
            <v-text-field
              ...
              counter="6"
            />
            <v-btn v-t="'btn.resend'" text color="primary" @click.stop.prevent="resendCode" />
            <v-btn
              v-t="'btn.confirm'"
              :disabled="protectedUI || disableAllInputs"
              type="submit"
