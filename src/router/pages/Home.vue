        ...
        <section>
            <v-parallax src="/static/img/hero.jpeg" height="600">
                ...
                >
                    ...
                    <div class="subheading mb-3 text-xs-center">Warp your time</div>
                        ...
                        <v-layout row wrap align-center>
                            ...
                            <v-flex xs12 md4>
                                <v-card class="elevation-0 transparent">
                                    ...
                                    <v-card-text>
                                        All photos that are not added due to group restrictions will be scheduled taking
                                        in consideration each group restrictions.
                                    </v-card-text>
                                </v-card>
                            </v-flex>
                        </v-layout>
