<template>
    <v-content>
        <section>
            <v-parallax src="/static/img/weat_field.jpg" height="600">
                ...
                >
                    ...
                    <v-tooltip top>
                        <v-btn dark large class="primary lighten-2 mt-5" :to="{ path: 'signup' }" slot="activator">
                            Try our Beta
                        </v-btn>
                    ...
                    <v-container fill-height>
                        <v-layout align-center>
                            <v-flex>
                                ...
                                <v-btn large color="primary" class="mx-0" href="#how-it-works">Read more</v-btn>
                            </v-flex>
                        </v-layout>
                    </v-container>
                </v-jumbotron>
        ...
        <section>
            <v-parallax src="/static/img/hero.jpeg" height="380">
